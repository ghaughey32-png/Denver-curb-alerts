...
with 😱 — decided 2026-09-23 by the app's author. A plan the driver cancelled is red too, but leads
with ☠️ (skull and crossbones) instead of the scream. The device's notices carry the same 😱 in their titles (`AccessNoticePlanner.alarm`),
