(function attachCityRegistry(root, factory) {
  ...
  const DENVER = {
    ...
    // Whether the website sends sweep reminders. False since 2026-09-23: reminders are what the iPhone
    // app sells, and a free website sending the same ones would be a way around the subscription.
    // The map, schedules, saved curbs and accounts stay on the website. The page and server.js both
    // read this, and the iPhone app ignores it - its reminders are the product.
    webReminders: false,
    // The Curb Alerts App Store listing, offered on the website in place of reminders. Null until
    // Apple approves the app, because the listing does not exist before then; set it on launch day to
    // "https://apps.apple.com/app/id6812789158" (Apple ID 6812789158).
    appStoreUrl: null,
